...
export const whatsappNumber = "5551999105739"

export default function Contact() {

  const instagramUser = "amigossbarbearia" 
  const address = "Av. Paraguassú, 2257 - Imbé, RS"
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="ml-6">
                  ...
                  <p className="text-xl font-bold group-hover:text-primary transition-colors">(51) 99910-5739</p>
                </div>
              </a>
          ...
          <div className="w-full lg:w-1/2 h-[450px] relative group">
            ...
            <div className="relative z-10 w-full h-full bg-zinc-900 overflow-hidden rounded-sm grayscale contrast-[0.9] hover:grayscale-0 transition-all duration-700">
               <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d110575.77833497665!2d-50.29089035664063!3d-29.99399530000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x951873765b98fd7b%3A0xc1088e8fc6debab6!2sAmigos%20Barbearia!5e0!3m2!1spt-BR!2sbr!4v1770704147086!5m2!1spt-BR!2sbr" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
